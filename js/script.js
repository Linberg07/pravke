...
$(function(){
	...
	$('.input_coast').click(function(){
		$('.subbmit__agree').addClass('active');
		$('.subbmit__agree_car').addClass('active');
	})
...
$(document).ready(function(){
	...
	console.log(w);
	if(w<768){
		$('.swiper-paginationHeader').prependTo('.mob_pagination');
	}else{
		$('.swiper-paginationHeader').prependTo('.swiper-containerWork');
	}
